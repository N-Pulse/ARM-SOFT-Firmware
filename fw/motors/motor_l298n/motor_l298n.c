...
static const l298n_motor_t s_motors[MOTOR_COUNT] = {
    ...
    /* RING deplace du slave vers le master (L298N slave HS) : PWM sur
     * TIM4_CH3 / PB8, IN1=PB0, IN2=PB1 (anciennes pins de WRIST_Y). */
    [MOTOR_RING]    = { TIM4, TIM_CHANNEL_3, GPIOB, GPIO_PIN_8,  GPIO_AF2_TIM4, GPIOB, GPIO_PIN_0,  GPIOB, GPIO_PIN_1  },
