...
static const l298n_motor_t s_motors[MOTOR_COUNT] = {
    ...
    /* RING : PWM sur TIM1_CH1 / PA8 (timer DIFFERENT de TIM4 utilise par
     * LITTLE, evite les soupcons de coupling TIM4_CH1<->CH3). IN1=PC4,
     * IN2=PC5 (anciennes pins de WRIST_X de la branche simulation_pipeline,
     * confirmees fonctionnelles a l'epoque). */
    [MOTOR_RING]    = { TIM1, TIM_CHANNEL_1, GPIOA, GPIO_PIN_8,  GPIO_AF6_TIM1, GPIOC, GPIO_PIN_4,  GPIOC, GPIO_PIN_5  },
