...
static const l298n_motor_t s_motors[MOTOR_COUNT] = {
    ...
    [MOTOR_WRIST_Y] = { TIM4, TIM_CHANNEL_3, GPIOB, GPIO_PIN_8,  GPIO_AF2_TIM4, GPIOC, GPIO_PIN_6,  GPIOC, GPIO_PIN_7  },
    [MOTOR_PALM]    = { TIM4, TIM_CHANNEL_4, GPIOB, GPIO_PIN_9,  GPIO_AF2_TIM4, GPIOC, GPIO_PIN_2,  GPIOC, GPIO_PIN_3  },
};
