...
/*
 * motor_l298n — generic L298N H-bridge driver for the 6 hand motors
 * (THUMB, INDEX, MIDDLE, RING, LITTLE, PALM). Build "presentation" : pas
 * de poignet — voir branche `simulation_pipeline` pour la version complète.
 *
