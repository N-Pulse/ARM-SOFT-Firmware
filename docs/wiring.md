...
|--------|-------------------|-----------|-----|-----|---------------------|---------------------|
| **WRIST_X** | → M+, M− moteur WRIST_X | PB7 (TIM4_CH2, AF2) | PC4 | PC5 | PA0 (TIM2, AF1) | PA1 (TIM2, AF1) |
| **WRIST_Y** | → M+, M− moteur WRIST_Y | PB8 (TIM4_CH3, AF2) | PB0 | PB1 | PC6 (TIM8, AF4) | PC7 (TIM8, AF4) |
| **LITTLE** | → M+, M− moteur LITTLE | PB6 (TIM4_CH1, AF2) | PC8 | PC9 | PA6 (TIM3, AF2) | PA7 (TIM3, AF2) |

> ⚠️ **WRIST_X + WRIST_Y = poignet différentiel couplé.** Ils sont commandés en synchro (`drive_wrist()`), c'est pour ça qu'ils sont sur la même carte. Même sens → rotation, sens opposé → flexion.
...
| **THUMB** | → M+, M− moteur THUMB | PA8 (TIM1_CH1, AF6) | PB5 | PB4 | PB14 (TIM15, AF1) | PB15 (TIM15, AF1) |
...
Master = motherboard (WRIST_X, WRIST_Y, LITTLE). Slave = daughterboard (INDEX, MIDDLE, RING, THUMB, PALM).

| Pin | Master | Slave | Périphérique |
|-----|--------|-------|--------------|
| PA0 | WRIST_X Enc A | INDEX Enc A | TIM2 CH1 |
| PA1 | WRIST_X Enc B | INDEX Enc B | TIM2 CH2 |
...
| PB12 | — | RING IN1 | GPIO |
| PB13 | — | RING IN2 | GPIO |
| PB14 | — | THUMB Enc A | TIM15 CH1 |
| PB15 | — | THUMB Enc B | TIM15 CH2 |
| PC0 | Flottant (pull-up) | GND | Strap rôle |
| PC2 | — | PALM Enc B | TIM20 CH2 |
| PC3 | — | PALM IN2 | GPIO |
| PC4 | WRIST_X IN1 | — | GPIO |
| PC5 | WRIST_X IN2 | — | GPIO |
| PC6 | WRIST_Y Enc A | RING Enc A | TIM8 CH1 |
| PC7 | WRIST_Y Enc B | RING Enc B | TIM8 CH2 |
| PC8 | LITTLE IN1 | — | GPIO |
| PC9 | LITTLE IN2 | — | GPIO |
| PC10 | — | INDEX IN1 | GPIO |
| PC11 | — | INDEX IN2 | GPIO |
